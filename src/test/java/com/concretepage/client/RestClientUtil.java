...
public class RestClientUtil {
	...
	public void getArticleByCategory() {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		RestTemplate restTemplate = new RestTemplate();
		String url = "http://localhost:8080/user/onlyjava";
		System.out.println("The end of getArticleByCategory()");
		//HttpEntity<String> requestEntity = new HttpEntity<String>(headers);
		...
		ResponseEntity<Article[]> responseEntity = restTemplate.getForEntity(url, Article[].class, HttpMethod.GET, requestEntity );
		//Article article = responseEntity.getBody();
		//for(Article article : articles) {
		//	System.out.println("Id:"+article.getArticleId()+", Title:"+article.getTitle()
		//			+", Category: "+article.getCategory());
